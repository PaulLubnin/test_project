...
from books_core.models import Author, Genre, Language, Book, BookInstance
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'books_core/author_list.html')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'books_core/bookinstance_list_borrowed_user.html')
